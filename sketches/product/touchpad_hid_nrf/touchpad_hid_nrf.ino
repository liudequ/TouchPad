...
static unsigned long bleIdleLightMs = IDLE_SLEEP_MS * 10;
static unsigned long bleIdleMediumMs = IDLE_SLEEP_MS * 30;
static unsigned long bleIdleSleepMs = IDLE_SLEEP_MS * 60;
...
void applyDefaults() {
  ...
  bleIdleLightMs = IDLE_SLEEP_MS * 10;
  bleIdleMediumMs = IDLE_SLEEP_MS * 30;
  bleIdleSleepMs = IDLE_SLEEP_MS * 60;
